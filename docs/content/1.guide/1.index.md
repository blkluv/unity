...
Luv is an alternative way to access your Mastodon account from your browser.

Through the Mastodon API, Luv provides similar access to posts and actions on posts you expect to be able to do to Mastodon.
...
Want to try it out?
Visit https://luvnft.com, type in your Mastodon server address, then log in.
Or, visit one of the other Elk installs in the [Luv ecosystem](https://github.com/blkluv/unity#ecosystem).
